    ...
    return (
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            {/* Search Component */}
            <div className="py-4 flex flex-col items-center  bg-tania-700">
            ...
            <div className="flex mt-4 lg:hidden justify-between items-center w-full px-5 ">
                ...
                <button className="bg-tania-700 rounded py-1 px-4">Filters</button>
            </div>
                ...
                <div className="lg:block w-[270px] mt-10">
                    ...
                    <div className="flex flex-col gap-5 mt-4">
                        <div className="flex justify-between">
                            <button onClick={searchResultsHandler} className="bg-tania-800 text-white rounded px-4 py-1 text-sm ">Apply</button>
                            <button onClick={clearFilters} className="bg-tania-800 text-white rounded px-4 py-1 text-sm">Clear</button>
                        </div>
                        <div className="">
                ...
                <div className="h-[65vh] pt-5  w-full lg:px-2 lg:mx-auto overflow-y-scroll  ">
                    ...
                    <div className=" flex flex-col gap-3 md:grid md:grid-cols-1 items-center lg:grid-cols-3  lg:gap-x-3  lg:gap-y-3 ">
                        ...
                        <div className="flex flex-col p-3 w-[230px] h-[250px] border-2 border-black rounded items-center">
                                ...
                                <button onClick={openModal} className=" mt-2 bg-tania-700 text-white text-sm rounded py-1 px-4">Message</button>
